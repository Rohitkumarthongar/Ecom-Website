          ...
          traverse(ast, {
            JSXOpeningElement: (path) => {
              ...
              changesAtLine.forEach((change) => {
                ...
                // Processing change type for element
                ...
                if (
                  ...
                  // Processing content-only change
